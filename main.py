...
BOT_TOKEN = "6800323225:AAEyUBneAHY4rNI5vtYQpb1k9fV7YMjfeSs"
PAYMENT_CHANNEL = "@testpostchnl" #add payment channel here including the '@' sign
OWNER_ID = 6855424120 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@kriss_netflix"]# to be checked here in the format - ["Channel 1", "Channel 2"] 
